...
export const SUBSCRIPTION_PLANS: Record<SubscriptionPlanId, SubscriptionPlanDefinition> = {
  ...
  kopi_susu: {
    ...
    prices: { monthly: 49000, quarterly: 129000, yearly: 490000 },
  ...
  signature: {
    ...
    prices: { monthly: 99000, quarterly: 269000, yearly: 990000 },
    ...
    features: [
      ...
      'Monitoring operasional lebih lengkap',
    ],
  },
  founder: {
    id: 'founder',
    ...
    prices: { monthly: 199000, quarterly: 539000, yearly: 1990000 },

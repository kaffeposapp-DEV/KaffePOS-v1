...
revoke all on function public.cleanup_operational_retention(integer, integer, integer, integer)
  from public, anon, authenticated;
grant execute on function public.cleanup_operational_retention(integer, integer, integer, integer)
  to service_role;
